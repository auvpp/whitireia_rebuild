    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="{{url('school/add-class')}}" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input name="class_number" class="form-control" id="classNumber{{$school->id}}" placeholder="@lang('Class Number/Name')" required>
            </div>
          </div>
          {{--<div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input class="form-control" name="group" id="classRoomNumber{{$school->id}}" placeholder="@lang('Science, Commerce, Arts, etc.')">
