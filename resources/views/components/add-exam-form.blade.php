<form class="form-horizontal" action="{{url('exams/create')}}" method="post">
    ...
    <div class="form-group{{ $errors->has('exam_name') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <input id="exam_name" class="form-control" name="exam_name" value="{{ old('exam_name') }}" placeholder="@lang('Semester 1 Exam 2018, Final Exam 2019, ...')" required>
    ...
    <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <input id="start_date" class="form-control" name="start_date" value="{{ old('start_date') }}" placeholder="@lang('5th April...')" required>
    ...
    <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <input id="end_date" class="form-control" name="end_date" value="{{ old('end_date') }}" placeholder="@lang('20th April...')" required>
