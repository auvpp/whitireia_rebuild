...
<!-- Modal for exclude information (BUS9503 is mutual exclusive of BUS9501 and BUS9503) -->
<div class="modal fade" id="excludeCourseModal" tabindex="-1" role="dialog" aria-labelledby="excludeCourseModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-info text-white" >          
        ...
        <h4 class="modal-title" id="excludeCourseModalLabel">@lang('Notice')</h4>
      </div>
      <div class="modal-body">
        <div class="row" style="margin-bottom:7px;">
          <div class="col-sm-1"></div>
          <div class="col-sm-10">
            <h4><b>@lang('BUS9502 is mutual exclusive of BUS9501 or BUS9503.')</b></h4>
          </div>    
        </div>
      </div>    
      <div class="modal-footer">
