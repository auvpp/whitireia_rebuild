                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="{{url('create-gpa')}}" method="post">
                      ...
                      <div class="form-group{{ $errors->has('grade_system_name') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="grade_system_name" class="form-control" name="grade_system_name" value="{{ old('grade_system_name') }}" placeholder="@lang('Grade System Name')" required>
                      ...
                      <div class="form-group{{ $errors->has('grade') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="grade" class="form-control" name="grade" value="{{ old('grade') }}" placeholder="A+, A, A-, B+, ..." required>
                      ...
                      <div class="form-group{{ $errors->has('point') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="point" class="form-control" name="point" value="{{ old('point') }}" placeholder="5.00, 4.50, ..." required>
                      ...
                      <div class="form-group{{ $errors->has('from_mark') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="from_mark" class="form-control" name="from_mark" value="{{ old('from_mark') }}" placeholder="@lang('Example: 80')" required>
                      ...
                      <div class="form-group{{ $errors->has('to_mark') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              <input id="to_mark" class="form-control" name="to_mark" value="{{ old('to_mark') }}" placeholder="@lang('Example: 90')" required>
